...
var _PgBossJob_defaultJobOptions, _PgBossJob_startAfter;
...
class PgBossJob extends Job {
    ...
    constructor(jobName, defaultJobOptions, startAfter = undefined) {
        ...
        _PgBossJob_defaultJobOptions.set(this, void 0);
        _PgBossJob_startAfter.set(this, void 0);
        __classPrivateFieldSet(this, _PgBossJob_defaultJobOptions, defaultJobOptions, "f");
        __classPrivateFieldSet(this, _PgBossJob_startAfter, startAfter, "f");
    }
    /**
     ...
     */
    delay(startAfter) {
        return new PgBossJob(this.jobName, __classPrivateFieldGet(this, _PgBossJob_defaultJobOptions, "f"), startAfter);
    }
    /**
    ...
    async submit(jobArgs, jobOptions = {}) {
        ...
        const jobId = await boss.send(this.jobName, jobArgs, Object.assign(Object.assign(Object.assign({}, __classPrivateFieldGet(this, _PgBossJob_defaultJobOptions, "f")), (__classPrivateFieldGet(this, _PgBossJob_startAfter, "f") && { startAfter: __classPrivateFieldGet(this, _PgBossJob_startAfter, "f") })), jobOptions));
        return new PgBossSubmittedJob(boss, this, jobId);
    }
}
_PgBossJob_defaultJobOptions = new WeakMap(), _PgBossJob_startAfter = new WeakMap();
/**
